...
import './DeepHoroscopeInput.css';

interface DeepHoroscopeInputProps {
...
/**
 * Deep Horoscope Input Form Component
 * Allows users to enter birth data for comprehensive horoscope interpretation
 */
const DeepHoroscopeInput: React.FC<DeepHoroscopeInputProps> = ({
  onSubmit,
  loading = false,
  error
}) => {
  ...
  return (
    <div className="deep-horoscope-input">
      <div className="input-header">
        <h2>Enter Your Birth Details</h2>
        <p>Provide accurate birth information for comprehensive Vedic horoscope interpretation covering all life aspects</p>
      </div>
      ...
      <form onSubmit={handleSubmit} className="birth-data-form">
        ...
        <div className="form-actions">
          ...
          >
            {loading ? 'Generating Deep Horoscope...' : 'Generate Deep Horoscope'}
          </button>
          <small id="generate-button-help" className="button-help">
            This will generate a comprehensive Vedic horoscope interpretation covering planetary analysis, life areas, yogas, predictions, and remedial guidance
          </small>
        </div>
      </form>
      ...
      <div className="privacy-notice">
        ...
        <p>
          <strong>Important:</strong> For accurate predictions, please ensure your birth time is as precise as possible.
          The deep horoscope analysis provides guidance and should not replace professional advice.
        </p>
      </div>
    </div>
  );
...
export default DeepHoroscopeInput;